...
public class SmartMeterStatisticsDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SmartMeterStatisticsDTO)) return false;
        SmartMeterStatisticsDTO that = (SmartMeterStatisticsDTO) o;
        return Objects.equals(getSmartMeterDescription(), that.getSmartMeterDescription()) &&
                Objects.equals(getAverageSpentPerDay(),
                that.getAverageSpentPerDay()) &&
                Objects.equals(getAverageSpentPerNight(), that.getAverageSpentPerNight())
                && Objects.equals(getCumulativePowerConsumption(), that.getCumulativePowerConsumption()) &&
