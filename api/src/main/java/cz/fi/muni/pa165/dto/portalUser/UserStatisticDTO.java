...
public class UserStatisticDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof UserStatisticDTO)) return false;
        UserStatisticDTO that = (UserStatisticDTO) o;
        return Objects.equals(getUserName(), that.getUserName()) &&
                Objects.equals(getFromToTotalSpent(), that.getFromToTotalSpent()) &&
                Objects.equals(getFromToAverageSpent(), that.getFromToAverageSpent());
    }
