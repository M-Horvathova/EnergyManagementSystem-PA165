...
public class SmartMeterDTO {
    ...
    public boolean equals(Object o) {
        ...
        return isRunning() == sm.isRunning() &&
                ...
                sm.getSmartMeterDescription() == null) ||
                (getSmartMeterDescription() != null &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(isRunning(), getPowerConsumptionSinceLastLog(),
                getCumulativePowerConsumption(), getHouseId(), getSmartMeterDescription());
    }
