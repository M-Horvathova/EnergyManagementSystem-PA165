...
public class SmartMeterStatsIntervalDTO {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getCumulativePowerConsumption(), getCumulativePowerConsumption()) == 0 && Double.compare(that.getTotalSpentPerNight(), getTotalSpentPerNight()) == 0 && Double.compare(that.getTotalSpentPerDay(), getTotalSpentPerDay()) == 0;
    }
