...
public class SmartMeterPowerSpentInIntervalDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof SmartMeterPowerSpentInIntervalDTO)) return false;
        SmartMeterPowerSpentInIntervalDTO that = (SmartMeterPowerSpentInIntervalDTO) o;
        return Objects.equals(getDayFrom(), that.getDayFrom()) && Objects.equals(getMonthFrom(), that.getMonthFrom()) && Objects.equals(getYearFrom(), that.getYearFrom())
                && Objects.equals(getDayTo(), that.getDayTo()) && Objects.equals(getMonthTo(), that.getMonthTo()) && Objects.equals(getYearTo(), that.getYearTo());
    }
