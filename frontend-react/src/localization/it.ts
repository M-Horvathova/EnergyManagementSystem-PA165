...
const en = {
  translation: {
    ...
    smartMeter: {
      ...
      create: "Crea",
      edit: "Modifica",
      intervalStats: "Statistiche nell'intervallo di date scelto",
      open: "Apri",
      powerSpentForDate: "Mostra la potenza speso per la data",
      powerSpentFromDate: "Seleziona la data di inizio",
      powerSpentToDate: "Seleziona la data di fine",
      remove: "Rimuovi",
      totalPowerConsumption: "Consumo energetico totale",
      totalPowerConsumptionAtNight: "Consumo energetico totale durante la notte a intervalli",
      totalPowerConsumptionInDay: "Consumo energetico totale in giorno nell'intervallo",
      totalPowerConsumptionInterval: "Consumo energetico totale in intervallo",
      totalStats: "Statistiche per questo Smart Meter",
