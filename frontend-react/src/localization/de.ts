...
const en = {
  translation: {
    ...
    house: {
      ...
      off: "Schalten Sie den Strom",
      on: "Schalten Sie Strom ein",
      open: "Öffnen",
      remove: "Entfernen"
    },
    houseForm: {
    ...
    smartMeter: {
      ...
      create: "Erstellen",
      edit: "Bearbeiten",
      intervalStats: "Statistiken im gewählten Datumsintervall",
      open: "Öffnen",
      powerSpentForDate: "Anzeige der für das Datum verbrauchten Leistung",
      powerSpentFromDate: "Startdatum wählen",
      powerSpentToDate: "Enddatum wählen",
      remove: "Löschen",
      totalPowerConsumption: "Gesamter Stromverbrauch",
      totalPowerConsumptionAtNight: "Gesamtstromverbrauch bei Nacht im Intervall",
      totalPowerConsumptionInDay: "Gesamtstromverbrauch bei Tag im Intervall",
      totalPowerConsumptionInterval: "Gesamtstromverbrauch im Intervall",
      totalStats: "Statistiken für dieses Smart Meter",
