...
const en = {
  translation: {
    ...
    house: {
      ...
      off: "Vypnout elektřinu",
      on: "Zapnout elektřinu",
      open: "Otevřít",
      remove: "Odebrat"
    },
    houseForm: {
    ...
    smartMeter: {
      ...
      create: "Vytvořit",
      edit: "Upravit",
      intervalStats: "Statistika ve zvoleném datovém interval",
      open: "Otevřít",
      powerSpentForDate: "Zobrazit spotřebu energie pro datum",
      powerSpentFromDate: "Zvolte datum začátku",
      powerSpentToDate: "Zvolte datum konce",
      remove: "Odebrat",
      totalPowerConsumption: "Celková spotřeba energie",
      totalPowerConsumptionAtNight: "Celková spotřeba energie v noci v intervalu",
      totalPowerConsumptionInDay: "Celková spotřeba energie ve dne v intervalu",
      totalPowerConsumptionInterval: "Celková spotřeba energie v intervalu",
      totalStats: "Statistiky tohoto smart meteru",
      turnedOff: "Vypnuto",
      turnedOn: "Zapnuto"
    },
    smartMeterForm: {
