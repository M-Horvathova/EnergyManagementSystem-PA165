...
const en = {
    translation: {
        about: {
            creators:
                "Vytvořili Michaela Horváthová, Patrik Valo, Martin Podhora, Matej Rišňovský, 2021",
            description1:
                "Tato aplikace byla vyvinuta jako součást předmětu PA165 Enterprise Applications in Java na Masarykově univerzitě",
            description2:
            ...
            git:
                "Projekt je dostupný v úložišti GitHubu https://github.com/M-Horvathova/EnergyManagementSystem-PA165",
