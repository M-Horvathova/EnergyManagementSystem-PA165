...
const en = {
  translation: {
    ...
    house: {
      ...
      off: "Apague la electricidad",
      on: "Encienda la electricidad",
      open: "Abrir",
      remove: "Eliminar"
    },
    houseForm: {
    ...
    smartMeter: {
      ...
      create: "Crear",
      edit: "Editar",
      intervalStats: "Estadísticas en el intervalo de fechas elegido",
      open: "Abrir",
      powerSpentForDate: "Mostrar energía gastada para la fecha",
      powerSpentFromDate: "Seleccionar fecha de inicio",
      powerSpentToDate: "Seleccionar fecha de finalización",
      remove: "Eliminar",
      totalPowerConsumption: "Consumo total de energía",
      totalPowerConsumptionAtNight: "Consumo total de energía por la noche en intervalos",
      totalPowerConsumptionInDay: "Consumo total de energía en el día en el intervalo",
      totalPowerConsumptionInterval: "Consumo total de energía en el intervalo",
      totalStats: "Estadísticas de este medidor inteligente",
