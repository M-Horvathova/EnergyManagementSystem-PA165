                ...
                <List className={classes.list}>
                    { <>
                        ...
                        <ListItem divider alignItems='center'>
                            ...
                            <Link className={classes.link} to="/pa165" onClick={handleDrawerClose}><b>{t('menu.home')}</b></Link>

                        </ListItem>
                        <ListItem divider>
                            <ListItemIcon> <InfoIcon /> </ListItemIcon>
                            <Link className={classes.link} to="pa165/about/" onClick={handleDrawerClose}><b>{t('menu.about')}</b></Link>
